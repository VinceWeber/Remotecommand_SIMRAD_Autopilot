...
/*
//ACTION 1 = ON/OFF bouton mode

    if (action_encours[0]==1)  {
        boucle_cpt=boucle_cpt+1;
        Serial.println(boucle_cpt);
       ...
       if (action_encours[1]==1) {
        ...
        action_encours[2]=currentTime+Duree_pression; // fixe l'heure à laquelle l'action sera obsolète
        Serial.println("Initialisation de l'Action");
...
//ACTION 2 = BABORD 1° bouton mode

    if (action_encours[0]==2)  {
        boucle_cpt=boucle_cpt+1;
        Serial.println(boucle_cpt);
...
//ACTION 3 = TRIBORD 1° bouton tribo

    if (action_encours[0]==3)  {
        boucle_cpt=boucle_cpt+1;
        Serial.println(boucle_cpt);
...
//ACTION 4 = -10° bouton left

    if (action_encours[0]==4)  {
        Serial.println(boucle_cpt);
